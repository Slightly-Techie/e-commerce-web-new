...
export default function Review() {
  return (
    <main className="flex h-screen w-full flex-col bg-gray75">
      <div className="absolute top-0 flex h-[77px] w-full items-center justify-center bg-white">
        <img src={logo} />
      </div>
      <section className="mt-[77px] flex h-full w-full items-center justify-center">
        <article className="shadow-order flex w-[95%] flex-col items-center justify-center rounded-[14px] border border-gray100 bg-white p-4 md:w-[514px] md:p-8">
          <div className="flex flex-col items-center">
            ...
            />
            <h1 className="mb-1.5 mt-3 text-[28px] font-bold text-darkPrimary">
              Mensah Michael
            </h1>
          ...
          <Button className="mt-6 w-full md:mt-12">Submit review</Button>
        </article>
      </section>
    </main>
  );
