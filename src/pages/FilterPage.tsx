import FilterPageHeader from "@/components/filter/FilterPageHeader";
...
export default function FilterPage() {
  ...
  return (
    <section
      className={`mx-auto max-w-[1440px] ${filterSidebarState ? "flex gap-6" : ""} `}
    >
      <article
      ...
      >
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-x-8 gap-y-12 sm:justify-between lg:gap-x-[15px] xl:gap-x-5">
